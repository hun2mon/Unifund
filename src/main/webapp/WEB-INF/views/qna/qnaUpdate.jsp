    ...
    <div class="form-container">
        ...
        <form id="qnaUpdateForm" action="./update.do" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="qna_title" name="qna_title" maxlength="20" value="${qnaDTO.qna_title}">
            </div>

            <div class="form-group">
                <label for="qna_content">내용:</label>
                <textarea class="form-control" id="qna_content" name="qna_content" rows="12" cols="50">${qnaDTO.qna_content}</textarea>
            </div>

            <div class="checkbox">
                <label>
                    <input type="checkbox" id="qna_show" name="qna_show" ${qnaDTO.qna_show == '비공개' ? 'checked' : ''}> 비공개
                </label>
            </div>

            <div id="passwordField" style="${qnaDTO.qna_show == '비공개' ? 'display:block;' : 'display:none;'}">
                <div class="form-group">
                    <label for="qna_pass">비밀번호:</label>
                    <input type="password" class="form-control" id="qna_pass" name="qna_pass" value="${qnaDTO.qna_pass}">
                </div>
            </div>
