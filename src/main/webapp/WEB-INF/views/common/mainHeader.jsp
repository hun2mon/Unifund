  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="project/list.go?category=1" class="w3-bar-item w3-button w3-hover-purple">전시회</a>
        <a href="project/list.go?category=2" class="w3-bar-item w3-button w3-hover-purple">공연</a>
        <a href="project/list.go?category=3" class="w3-bar-item w3-button w3-hover-purple">축제</a>
        <a href="project/list.go?category=4" class="w3-bar-item w3-button w3-hover-purple">창작물</a>
        <a href="project/list.go?category=5" class="w3-bar-item w3-button w3-hover-purple">기타</a>
      </div>
