...
<div class="w3-top">
  ...
  <div class="w3-bar w3-white w3-card">
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      <button class="w3-padding-large w3-button w3-hover-purple" title="More" onclick="javascript:location.href='project/list.go'">프로젝트<i class="fa fa-caret-down"></i></button>     
